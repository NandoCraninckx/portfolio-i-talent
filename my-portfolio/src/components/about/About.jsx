        ...
        <section className="about section" id="about">
            <div className="about-container container grid">
                <div className="about-content grid">
                    ...
                    <p className="about-paragraph">
                    Mij continu blijven bijscholen en het verbeteren van mijn vaardigheden schrikt mij zeker niet af. Daarom is het vak I-Talent dat een student aanzet en motiveert om zichzelf verder te ontplooien een fijn iets. 
                    In dat kader ben ik dan op zoek gegaan naar drie projecten die mij enerzijds een nieuwe uitdaging geven en anderzijds bijdragen aan mijn verdere ontplooiing in de IT-wereld.
                    </p>
                </div> 
            </div>
        </section>  
